...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not current_place.is_hive:
            ...
            current_place, count = current_place.entrance, count + 1
        return None
        # END Problem 3 and 4
    ...
    def insects_in_front(self):
        ...
        while not place.is_hive:
            for bee in place.bees:
                insects_distances[bee] = distance
            if place.ant and place.ant is not self:
                insects_distances[place.ant] = distance
                if place.ant.is_container and place.ant.ant_contained is not self:
                    insects_distances[place.ant.ant_contained] = distance
            distance += 1
