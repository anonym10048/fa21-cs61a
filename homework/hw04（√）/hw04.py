...
def balanced(m):
    ...
    return left_len * left_weight == right_len * right_weight
...
def preorder(t):
    ...
    if is_leaf(t):
        return [label(t)]
    return sum([[label(t)]] + [preorder(b) for b in branches(t)], [])
...
def div_interval(x, y):
    ...
    reciprocal of y."""
    "*** YOUR CODE HERE ***"
    assert 1 / lower_bound(y) >= 1 / upper_bound(y), 'AssertionError'
